  ...
  const Field = ({
    ...
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          set(name, type === "number" ? Number(e.target.value) : e.target.value as any)
        }
          ...
          <form onSubmit={handleSubmit}>
            <div className="p-6 grid grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-zinc-800 pt-4">
                  <div className="text-[10px] text-zinc-500 uppercase tracking-wider mb-3">Coordinates (optional)</div>
                  <div className="grid grid-cols-2 gap-3">
